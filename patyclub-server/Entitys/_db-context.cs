...
new EventMst {id = 12, categoryId = 4, status = "TEMP", cost = "1000", eventStDate = "2021/12/8", eventEdDate = "2021/12/8", eventCreateDate = "2021/12/02", examinationPassedDate = "", eventIntroduction = @"", eventDetail = @"", eventAttantion = @"", tag = "", eventTitle = "不想想活動名-A7"}
            ...
            modelBuilder.Entity<SysCodeDtl>()
                .HasData(
                    ...
                    new SysCodeDtl {id = 3, sysCodeMstKeyword = "eventStatus", codeName = "TEMP", codeDesc = "暫存中"},
                    new SysCodeDtl {id = 4, sysCodeMstKeyword = "eventStatus", codeName = "COMPLETE", codeDesc = "已完成未送審"},
                    new SysCodeDtl {id = 5, sysCodeMstKeyword = "eventStatus", codeName = "DELETE", codeDesc = "已刪除"},
                    new SysCodeDtl {id = 6, sysCodeMstKeyword = "eventPersonnel", codeName = "OWNER", codeDesc = "擁有者"},
                    new SysCodeDtl {id = 7, sysCodeMstKeyword = "eventPersonnel", codeName = "MEMBER", codeDesc = "成員"},
                    new SysCodeDtl {id = 8, sysCodeMstKeyword = "ageLimit", codeName = "<6", codeDesc = "6-"},
                    new SysCodeDtl {id = 9, sysCodeMstKeyword = "ageLimit", codeName = ">6", codeDesc = "6+"},
                    new SysCodeDtl {id = 10, sysCodeMstKeyword = "ageLimit", codeName = ">15", codeDesc = "15+"},
                    new SysCodeDtl {id = 11, sysCodeMstKeyword = "ageLimit", codeName = ">18", codeDesc = "18+"},
                    new SysCodeDtl {id = 12, sysCodeMstKeyword = "eventStatus", codeName = "AUDIT", codeDesc = "送審中"},
                    new SysCodeDtl {id = 13, sysCodeMstKeyword = "eventStatus", codeName = "AUDIT_PASS", codeDesc = "審核通過"},
                    new SysCodeDtl {id = 14, sysCodeMstKeyword = "eventPersonnel", codeName = "WATCHER", codeDesc = "關注者"}
                );
            modelBuilder.Entity<SysCodeMst>()
                .HasData(
                    new SysCodeMst {keyword = "eventTag", name = "TAG", remark = "活動標記代碼"},
                    new SysCodeMst {keyword = "eventStatus", name = "eventStatus", remark = "活動狀態代碼"},
                    new SysCodeMst {keyword = "eventPersonnel", name = "EventPersonnelPermission", remark = "活動人員權限"},
                    new SysCodeMst {keyword = "ageLimit", name = "ageLimit", remark = "年齡限制分級"}
                );
            modelBuilder.Entity<User>()
                .HasData(
